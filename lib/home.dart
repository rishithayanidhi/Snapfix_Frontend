      ...
      if (userEmail != null && userEmail.isNotEmpty) {
        ...
        if (response.success && response.data != null) {
          setState(() {
            ...
            _approvedComplaints = response.data!['approved']!;
            _rejectedComplaints = response.data!['rejected']!;
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _StatCard(
                      label: "Approved",
                      count: _approvedComplaints.toString(),
                      color: const Color(0xFF10B981),
                    ),
                    _StatCard(
                      label: "Rejected",
                      count: _rejectedComplaints.toString(),
